...
<div className="w-full px-4 sm:px-8 md:px-12 pb-10 border-b-2 border-dashed border-gray-200">
  <div className="pt-16 sm:pt-24 md:pt-28">
    ...
    <div className="py-8 sm:py-12 md:py-16 text-[#9C9C9C] text-sm ">
      <p>
        How our software scales from 5 operations per second to 1M operations per second in a blink on demand.
      </p>
  ...
  <div className="w-full lg:w-1/2 lg:px-6 px-4 space-y-4">
    <p className="text-2xl sm:text-3xl md:text-[40px] leading-snug">
      ...
      <span className="text-blue-500">
        eleifend accumsan quam. Nunc non leo vestibulum, laoreet tortor sed, suscipit enim.
      </span>
    </p>
    <p className="text-sm sm:text-base md:text-[18px] text-[#9C9C9C]">
      Nulla facilisi. Fusce sit amet arcu nec enim fringilla lacinia. Ut elit
      sapien, porttitor eget diam et, dictum sagittis urna. Fusce sit amet mi
      pellentesque, volutpat eros a, consectetur neque.
    </p>
  </div>
</div>
